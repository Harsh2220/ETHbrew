              ...
              <Flex align={"center"} justify={"center"}>
                ...
                >
                  ...
                  <form>
                    <FormControl id="userProfile">
                      ...
                      <Stack direction={["column", "row"]} spacing={6}>
                        <Center>
                          <Avatar size="xl" src={icon}></Avatar>
                        </Center>
                        <Center w="full">
                          <Input
                  ...
                  <FormControl id="email">
                    <FormLabel color="gray.800">Bio</FormLabel>
                    <Textarea
                ...
                >
                  ...
                  <SimpleGrid>
                    <FormControl
                      ...
                      colSpan={[3, 2]}
                    >
                      <FormLabel color="gray.800">Linkedin URL</FormLabel>
                  ...
                  <SimpleGrid>
                    <FormControl id="twitterUrl" as={GridItem} colSpan={[3, 2]}>
                      <FormLabel color="gray.800">Twitter URL</FormLabel>
                      <InputGroup borderColor={"gray.800"}>
                        <InputLeftAddon
                          bg="gray.800"
                          color="gray.500"
